...
class Type(object):
    def __init__(self, label, param_names = None, validator = None, docs = ""):
        self.label = label
...
class ContainerType(Type):
    ...
    """
    def __init__(self, label, param_names = None, validator = None, docs = ""):
        Type.__init__(self, label, param_names, validator, docs)
        self.children = []
...
class RecordType(ContainerType):
    def __init__(self, label, param_names = None, validator = None, docs = ""):
        ContainerType.__init__(self, label, param_names, validator, docs)
...
class Field(object):
    ...
    def __init__(self, field_type, name = None, default_value = None, docs = ""):
